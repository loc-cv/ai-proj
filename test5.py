...
# Read the image
image = cv2.imread("./images/phohue-map.png")
...
# corners = cv2.goodFeaturesToTrack(edges, maxCorners=99999, qualityLevel=0.01, minDistance=10)
...
#     x, y = corner.ravel()
#     cv2.circle(result_image, (x, y), 3, (0, 0, 255), -1)  # (0, 0, 255) corresponds to red
